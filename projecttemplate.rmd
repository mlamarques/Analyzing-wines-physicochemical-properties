...
In this plot an inverse correlation between density and alcohol, where the best quality tend to have more alcohol and be less dense.
...
In the third plot we have a small correlation and the quality of wines are more clumped together. But we can distinguish an area where there is a concentraion of most green dots, below the smooth line and 25 < free.sulfur.dioxide < 50. 

# Reflection

Eventhough the daset is not so large and wine quality classification is very subjective, there is some correlations between the physicochemical properties that we can notice.The most noticeble is the alcohol %. Higher quality wines have a higher percentage of alcohol, which is corralated with lower density and a lower residual sugar proportion. All of this features must have a considerable impact in the color, smell and taste of the wine.

These are only the most notible physical features that could influence the quality of white wines find in this daset. There are many other variables that could have influence in the quality of a wine. 

In addition to this project, it would be interesting to use some machine learning algorithm to analyze this dataset and also analyze the red wine dataset for comparerison.
