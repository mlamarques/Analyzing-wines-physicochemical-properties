...
```{r echo=FALSE, hist_volatile.acidity}
...
```{r echo=FALSE, hist_residual.sugar}
...
Chlorides seem to decrease as quality increases, though in a small proportion.
...
Chlorides variable has low variance.
