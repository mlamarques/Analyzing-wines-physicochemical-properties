...
```{r echo=FALSE, message=FALSE, warning=FALSE, hist_volatile.acidity}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, hist_citric.acid}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, hist_residual.sugar}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, hist_chlorides}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, hist_free.sulfur.dioxide}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, hist_density}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, hist_pH}
...
For Volatile Acidity, most values are around 25 for the values of quality above 4.
